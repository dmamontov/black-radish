...
Функция: Базовый функционал
  ...
  Данная функция представляет собой примеры базового функционала Black Radish Framework

  Правило: Управление потоком

    Сценарий: Пример ожидания
      Допустим я жду '1' секунду

  Правило: Работа с переменными
  ...
  Правило: Генераторы шагов
    ...
    Сценарий: Пример подключения сценария из текущей функции
      ...
      Если я подключаю сценарий 'Пример работы с переменными'
      Тогда '${ONE}' равно 'example'
